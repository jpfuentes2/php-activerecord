 ...
 *
 * Defining an Speedy\ActiveRecord model for a table called people and orders:
 *
 * <code>
 * CREATE TABLE people(
...
class Model extends Object
{
	 ...
	 * name of your table to explicitly tell Speedy\ActiveRecord what your table is called.
	 *
	 * @var string
	 */
	static $table_name;
	 ...
	 * Constructs a model.
	 *
	 * When a user instantiates a new object (e.g.: it was not Speedy\ActiveRecord that instantiated via a find)
	 ...
	 * EXAMPLE:
	 * <code>
	 * class User extends Speedy\ActiveRecord\Model {
	 *
	 ...
	 *
	 * @throws Speedy\ActiveRecord\ReadOnlyException
	 ...
	 *
	 * @throws Speedy\ActiveRecord\UndefinedPropertyException
	 ...
	 * @return Model
	 * @throws {@link Speedy\ActiveRecordException} if invalid query
	 * @see find
	 */
	...
	/**
	 * Determines if the specified array is a valid Speedy\ActiveRecord options array.
	 *
	 ...
	 * @throws {@link Speedy\ActiveRecordException} if the array contained any invalid options
	 */
   ...
   * Ex:
   * <code>
   * Speedy\ActiveRecord\CsvSerializer::$delimiter=';';
   * Speedy\ActiveRecord\CsvSerializer::$enclosure='';
