...
abstract class Connection
{
	 ...
	 *   OR
	 *   A connection name that is set in Speedy\ActiveRecord\Config
	 *   If null it will use the default connection specified by Speedy\ActiveRecord\Config->set_default_connection
	 * @return Connection
	 ...
	 * @param boolean $null
	 * @return string
	 * @throws Speedy\ActiveRecordException
	 */
	public function column($name, $type = null, $length = null, $null = true)
	{
		...
		if (!isset($native_types[$type]))
			throw new Speedy\ActiveRecordException("Column type not known for $name $type");
