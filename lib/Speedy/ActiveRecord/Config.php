...
use Closure;
use \Speedy\ActiveRecord\Exceptions\ConfigException;

require_once 'Utils.php';
/**
 * Manages configuration options for Speedy\ActiveRecord.
 *
 * <code>
 * Speedy\ActiveRecord::initialize(function($cfg) {
...
class Config extends Singleton
{
	 ...
	 *
	 * <code>
	 * Speedy\ActiveRecord\Config::initialize(function($cfg) {
	 ...
	 *
	 * <code>
	 * $config = Speedy\ActiveRecord\Config::instance();
	 * </code>
	 *
	 * @var string
	 */
	 ...
	 *
	 * <code>
	 * $cfg = Speedy\ActiveRecord\Config::instance();
	 * $cfg->set_model_directory('/path/to/your/model_directory');
	 ...
	 * @return void
	 * @throws Speedy\ActiveRecord\ConfigException
	 */
	...
	{
		trigger_error('Use Speedy\ActiveRecord\Serialization::$DATETIME_FORMAT. Config::get_date_format() has been deprecated.', E_USER_DEPRECATED);
	...
	{
		trigger_error('Use Speedy\ActiveRecord\Serialization::$DATETIME_FORMAT. Config::set_date_format() has been deprecated.', E_USER_DEPRECATED);
