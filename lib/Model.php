...
class Model
{
	...
	{
		return array_key_exists($attribute_name,$this->attributes) || array_key_exists($attribute_name,static::$alias_attribute) || static::table()->has_relationship($attribute_name);
	}
