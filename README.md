...
2. Setting the filename extension of your models class files (default : .php)
3. Configuring your database connections.
4. Setting the database connection to use for your environment.
